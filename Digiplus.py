    ...
    def registrar_escritura():
        ...
        def insertar_usuario():
            ...
            if mcursor.fetchone() is not None:
                ...
                bd = sqlite3.connect("login1.db")
                mcursor = bd.cursor()
                mcursor.execute("INSERT INTO Ingresar_usuario1 VALUES (?, ?, ?, ?, ?, ?, ?, ?)", (cedulavendedor_entry.get().strip(),  primerApellido1_entry.get().upper().strip(), segundoApellido1_entry.get().upper().strip(), primerNombre1_entry.get().upper().strip(), segundoNombre1_entry.get().upper().strip(), sexo1_entry.get().strip(), domicilio1_entry.get().strip(), estadocivil1_entry.get().strip()  ))
                bd.commit()
                bd.close()
        ...
        def insertar_usuario8():
            ...
            valor_cedula8= cedulacomprador3_entry.get()
            bd=sqlite3.connect("login1.db")
            mcursor = bd.cursor()
            #mcursor.execute("CREATE TABLE Ingresar_usuario1 (Cedula TEXT PRIMARY KEY,  Primer_Apellido TEXT, Segundo_Apellido TEXT, Primer_Nombre TEXT, Segundo_nombre TEXT, Sexo TEXT, Domicilio TEXT, Estado_Civil TEXT)")
        ...
        def insertar_usuario9():
            ...
            valor_cedula9= cedulacomprador4_entry.get()
            bd=sqlite3.connect("login1.db")
            mcursor = bd.cursor()
            #mcursor.execute("CREATE TABLE Ingresar_usuario1 (Cedula TEXT PRIMARY KEY,  Primer_Apellido TEXT, Segundo_Apellido TEXT, Primer_Nombre TEXT, Segundo_nombre TEXT, Sexo TEXT, Domicilio TEXT, Estado_Civil TEXT)")
        ...
        def insertar_usuario12():
            ...
            if mcursor.fetchone() is not None:
                ...
                bd = sqlite3.connect("login1.db")
                mcursor = bd.cursor()
                mcursor.execute("INSERT INTO Ingresar_usuario1 VALUES (?, ?, ?, ?, ?, ?, ?, ?)", (cedulacomprador6_entry.get().strip(),  con6_primerApellido_entry.get().upper().strip(), con6_segundoApellido_entry.get().upper().strip(), con6_primerNombre_entry.get().upper().strip(), con6_segundoNombre_entry.get().upper().strip(), con6_sexo_entry.get().strip(), con6_domicilio_entry.get().strip(), con5_estadocivil_entry.get().strip()  ))
                bd.commit()
                bd.close()
